...
<html>
	<head>
		...
		<title>E-študent - študentski indeks</title>
	...
	<body>
		<div id="wraper">
			...
			<nav>
				...
				<a class="btn-link" href="<c:url>cert-order</c:url>">Naročilo potrdil</a>
				<a class="btn-link btn-link-curr" href="<c:url>std-index.jsp</c:url>">Študentski indeks</a>
				<a class="btn-link" href="<c:url>index</c:url>">Logout</a>
			</nav>
				<section class="main">
					<table>
						<tr>
							<th colspan=4>Študentski indeks</th>
						</tr>
						<tr>
							<th class="course">Predmet</th>
							<th>Datum opravljanja</th>
							<th>Število opravljanj</th>
							<th>Ocena</th>
						</tr>
						<tr>
